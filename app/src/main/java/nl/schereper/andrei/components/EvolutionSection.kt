package nl.schereper.andrei.components
...
@Composable
fun EvolutionSection(evolutions: List<nl.schereper.andrei.model.Pokemon>, onPokemonClick: (nl.schereper.andrei.model.Pokemon) -> Unit) {
    Column(
