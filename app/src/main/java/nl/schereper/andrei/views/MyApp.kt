...
import nl.schereper.andrei.PokemonApp
import nl.schereper.andrei.components.BottomNav
import nl.schereper.andrei.components.SearchBar
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("pokemonDetail/{pokemonId}") { backStackEntry ->
                ...
                if (pokemonId != null) {
                    val pokemon = remember { mutableStateOf<nl.schereper.andrei.model.Pokemon?>(null) }
