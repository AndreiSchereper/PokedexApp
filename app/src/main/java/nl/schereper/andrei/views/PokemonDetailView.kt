package nl.schereper.andrei.views
...
import nl.schereper.andrei.theme.LightColorScheme
import nl.schereper.andrei.theme.lightCustomColors
...
import nl.schereper.andrei.data.DataStore
import nl.schereper.andrei.components.EvolutionSection


@Composable
fun PokemonDetailView(
    pokemon: nl.schereper.andrei.model.Pokemon,
    ...
    val evolutionData = remember { mutableStateOf<List<nl.schereper.andrei.model.Pokemon>?>(null) }
...
fun sharePokemon(context: Context, pokemon: nl.schereper.andrei.model.Pokemon) {
